  ...
  return new EmbedBuilder()
    ...
    .setDescription(
      [
        ...
        "• There you will find 2 ways to post WTB's",
        "",
        "**✅ Option A — Single WTB**",
        ...
        "",
        "Your WTB Price will gradually go up over time (12 Hours), from Minimum Price to Maximum Price, just like our normal **Quick Deals**.",
        "",
        ...
        "",
        "⚠️ We do **NOT** pay the seller directly, your money is safe",
        "",
        ...
        "",
        "⚠️ Open a **Support Ticket** in <#1444838494760603769> to file a complaint. **NEVER** send complaints through DM, they will not be readed and lose validation.",
        "",
        "---",
        "## 6️⃣ Key Rules",
        "",
